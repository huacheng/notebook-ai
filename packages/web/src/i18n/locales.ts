...
export const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    'status.clear': 'Clear',
    'status.clearTitle': 'Clear context (restart without resume)',
    'status.rerun': 'Rerun',
    ...
    'sidebar.resetLabel': 'Reset {0}',
    'sidebar.resetConfirm': 'Reset {0}? Contents will be cleared; .working and .deliverables will be preserved.',
  ...
  zh: {
    ...
    'sidebar.resetLabel': '重置 {0}',
    'sidebar.resetConfirm': '重置 {0}？内容将清空，.working 与 .deliverables 保留。',
    'sidebar.cancel': '取消',
