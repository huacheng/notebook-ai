/**
 * Tests that autoTick broadcasts auto_heartbeat even when skipping the
...
describe('autoTick broadcasts even on skip', () => {
  it('should have auto_heartbeat broadcast AFTER the skip checks (not only in the send path)', () => {
    ...
    // Count how many times 'auto_heartbeat' appears — should be at the end,
