...
1. **Ingestion**: Read the file. If binary (PDF/Docx), delegate to `doc-parse` plugin. Sanitize topic name from filename (strip control chars, special YAML chars, path traversal sequences).
