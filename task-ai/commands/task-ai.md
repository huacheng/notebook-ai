...
```
$NB_WORK_DIR/                         ← notebook root (worktree)
├── .deliverables/                    ← output directory (outside .working/)
└── .working/                         ← $TASKAI_WORK_DIR — system files directory
    ├── .status.json                  ✓ correct
    ├── .target.md                    ✓ correct
    ├── .convergence-baseline.md      ✓ correct
    ├── .plan.md                      ✓ correct
    ├── .summary.md                   ✓ correct
    ├── .type-profile.md              ✓ correct
    ├── .analysis/                    ✓ correct
    ├── .test/                        ✓ correct
    ├── .bugfix/                      ✓ correct
    └── .notes/                       ✓ correct
...
**Wrong** (placed directly in worktree root):
```
$NB_WORK_DIR/.status.json             ✗ WRONG!
$NB_WORK_DIR/.target.md               ✗ WRONG!
```

**Correct**:
```
$TASKAI_WORK_DIR/.status.json         ✓ i.e. $NB_WORK_DIR/.working/.status.json
$TASKAI_WORK_DIR/.target.md           ✓ i.e. $NB_WORK_DIR/.working/.target.md
```
